...
tags:
  - "{tag}"
# Required. At least one tag. Use kebab-case. Tags must come from the
# controlled vocabulary in research/entities/_tags.md when possible.
# Free tags are allowed but should be normalized on next graph audit.
...
contradicts:
  ...
  # Always populate the resolution field in the entity body when this is set.
